            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('manage.blog.gallery.insert')}}" method="post" id="banner_image_form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="margin-top:25px;">
                                            <img src="{{URL::to('storage/app/public/blog')}}/{{@$value->image}}" style="width:100%;height:300px">
                                            <a class="btn btn-danger" href="{{route('manage.blog.gallery.delete',['id'=>$value->id])}}" style="margin-top: 20px;">Delete</a>
                                        </div>
                                        @endforeach
                                        @endif
                                    </div>
