...
@section('title')
<title>Admin | Manage Testimonial Edit</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Testimonial Edit</h4>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.testimonial.update')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
