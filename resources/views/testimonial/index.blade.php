            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.testimonial.add')}}">+ Add Testimonial</a></li>
                                        ...
                                        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ URL::to('storage/app/public/testimonial')}}/{{@$value->image}}" style="width: 100px;height:100px" id="img2"></td>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('manage.testimonial.edit',$value->id)}}" >Edit </a></li>
                                                                

                                                                <li><a href="{{route('manage.testimonial.delete',$value->id)}}" onclick="return confirm('Are sure want to delete the data ?')">Delete </a></li>
                                                             </ul>
                                                        </div>
                                                    </td>
                                                </tr>
